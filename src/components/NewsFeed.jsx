  ...
  return (
    <div className="bg-black py-8 ">
      <div className="container">
        <div className=" p-4  outline outline-1 outline-purple-950 shadow-lg shadow-purple-950  rounded-xl min-h-[100vh] flex flex-col gap-14">
          {data &&
            data.items?.map((news) => (
              <section
                key={news.id}
                className="text-white flex gap-4 outline outline-1 outline-purple-950 p-4"
              >
                <img
                  src={news.image}
                  alt="News Banner"
